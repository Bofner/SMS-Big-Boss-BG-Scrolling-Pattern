...
.sdsctag 0.1, "Worm Hole Game", "Dialogue and HBlank Focus","Bofner"
...
.enum $c000 export
    ...
    INTPattern      db          ;Used for repeating patterns with interrupts
...
.include "..\\Level_Files\\tunnelOne.asm"
...
TestMessage:
    ...
    .asc "Ready to enter the Worm   Hole?"
